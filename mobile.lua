local keys = {
     "Miku-JXGMK-E3BON-6QRVD-PKJSF", "Miku-IF9IC-Q4AFO-97TXS-966WB",
}
...
for i,v in pairs(keys) do
    if counter == #keys then
        keys = ""
        game.Players.LocalPlayer:Kick("Key Wrong | Mikuu Hub Script")
    else
        if v == getgenv().Key then 
--https://raw.githubusercontent.com/NguyeNvinhLp/ScriptMbFr/main/mobile.lua
...
--------------------------------------------------------------------
local Library = Update:Window("Miku HUB ","")
------------------------------------------
...
Setting:Button("Copy Discord Link",function()
 ...
 setclipboard("https://discord.gg/rAuPTRJj")
 end)
